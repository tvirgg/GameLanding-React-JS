...
function App() {
  ...
  return (
      <div>
        <Helmet title="Kingnight: Evolved" />
        <Favicon url={fav}/>
        {
        ...
        <section className="hero_sect" id="hero_sect_main">
          <div className="header">
            ...
            <div className="header_right">
              ...
              <a className="header_a" href="https://twitter.com/Kingnightsol1">
          ...
          <div className='App'>
            ...
            <a className="wrap_cent_btn" href="https://mint.Kingnight-evolved.com">
              <span>
                Soon
              </span>
            </a>
        ...
        <div className="about" >
          ...
          <div className="about_box">
            <div className="about_h1">
              WELCOME TO Kingnight
            </div>
            <div className="about_h2">
              Evolved
            </div>
            <div className="about_p">Kingnight Evolved is unique game assets that are set to redefine the gaming experience.
              <br></br> Each knight is developed with unparalleled attention to detail, from diverse weapons to evolutionary material enhancements, offering an immersive experience for every player. As a member of our community, you gain access to exclusive content and updates.
              The acquisition of your knight is just the beginning; we are dedicated to creating a high-quality game with its own currency, eventually leading to our own metaverse. We've successfully created before, and now we're back, ready to elevate Kingnight Evolved to new heights. Join us as we embark on this journey.
              <br></br>  Kingnight: Always advancing, never retreating!
            </div>
          </div>
        </div>
        <Galery/>
